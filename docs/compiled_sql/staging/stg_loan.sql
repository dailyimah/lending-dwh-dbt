...
select
    ...
    cast(nominal_request as numeric(28,6))  as nominal_request,
    cast(nominal_loan    as numeric(28,6))  as nominal_loan,
    upper(grade)                                as grade,
    lower(repayment_mode)                       as repayment_mode,
    cast(movement_status_id as TEXT) as current_movement_id,   -- type fix (INTEGER -> STRING)
